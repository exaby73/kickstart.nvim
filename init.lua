...
-- [[ Setting options ]]
-- Load all options from the separate options file
require 'options'
...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          -- Use our shared LSP keymaps
          local client = vim.lsp.get_client_by_id(event.data.client_id)
          require('custom.lsp-keymaps').on_attach(client, event.buf)
        end,
      })
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Disabled because I cannot figure out visual mode binds
